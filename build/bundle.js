...
var app = (function () {
    ...
    /* src\ZoomControl.svelte generated by Svelte v3.59.2 */
    const file$3 = "src\\ZoomControl.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			span = element("span");
    			t5 = text$1(/*zoomLevel*/ ctx[0]);
    			t6 = text$1("%");
    			attr_dev(button0, "class", "svelte-1f0cp0b");
    			add_location(button0, file$3, 22, 4, 561);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "10");
    			attr_dev(input, "max", "200");
    			attr_dev(input, "class", "svelte-1f0cp0b");
    			add_location(input, file$3, 23, 4, 609);
    			attr_dev(button1, "class", "svelte-1f0cp0b");
    			add_location(button1, file$3, 30, 4, 754);
    			attr_dev(span, "class", "svelte-1f0cp0b");
    			add_location(span, file$3, 31, 4, 802);
    			attr_dev(div, "class", "zoom-control svelte-1f0cp0b");
    			add_location(div, file$3, 21, 2, 529);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*decreaseZoom*/ ctx[1], false, false, false, false),
    					listen_dev(input, "change", /*input_change_input_handler*/ ctx[4]),
    					listen_dev(input, "input", /*input_change_input_handler*/ ctx[4]),
    					listen_dev(input, "input", /*handleSliderChange*/ ctx[3], false, false, false, false),
    					listen_dev(button1, "click", /*increaseZoom*/ ctx[2], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*zoomLevel*/ 1) set_data_dev(t5, /*zoomLevel*/ ctx[0]);
    		},
    		i: noop$4,
    		o: noop$4,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['zoomLevel'];
    ...
    class ZoomControl extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$3, create_fragment$3, safe_not_equal, { zoomLevel: 0 });
    	...
    	get zoomLevel() {
    		throw new Error("<ZoomControl>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set zoomLevel(value) {
    		throw new Error("<ZoomControl>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    /* src\NodeDetail.svelte generated by Svelte v3.59.2 */
    const file$2 = "src\\NodeDetail.svelte";

    // (8:2) {#if isOpen && node}
    function create_if_block(ctx) {
    	let div;
    	let h2;
    	let t0_value = /*node*/ ctx[1].data.name + "";
    	let t0;
    	let t1;
    	let h1;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 9, 6, 244);
    			add_location(h1, file$2, 10, 6, 277);
    			add_location(button, file$2, 11, 6, 305);
    			attr_dev(div, "class", "node-detail svelte-1a5vz47");
    			add_location(div, file$2, 8, 4, 168);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*node*/ 2) && t0_value !== (t0_value = /*node*/ ctx[1].data.name + "")) set_data_dev(t0, t0_value);
    		},
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*isOpen*/ ctx[0] && /*node*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*isOpen*/ ctx[0] && /*node*/ ctx[1]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*isOpen, node*/ 3) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['node', 'isOpen'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<NodeDetail> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ fly, node, isOpen });
    	...
    	return [isOpen, node, click_handler];
    }

    class NodeDetail extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$2, create_fragment$2, safe_not_equal, { node: 1, isOpen: 0 });
    ...
    /* src\TreeGraph.svelte generated by Svelte v3.59.2 */

    const { Object: Object_1 } = globals;
    const file$1 = "src\\TreeGraph.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	zoomcontrol = new ZoomControl({
    			props: { zoomLevel: /*zoomLevel*/ ctx[0] },
    			$$inline: true
    		});

    	zoomcontrol.$on("zoom", /*handleZoom*/ ctx[3]);

    	function nodedetail_node_binding(value) {
    		/*nodedetail_node_binding*/ ctx[5](value);
    	}

    	function nodedetail_isOpen_binding(value) {
    		/*nodedetail_isOpen_binding*/ ctx[6](value);
    	}

    	let nodedetail_props = {};

    	if (/*selectedNode*/ ctx[1] !== void 0) {
    		nodedetail_props.node = /*selectedNode*/ ctx[1];
    	}

    	if (/*isDetailOpen*/ ctx[2] !== void 0) {
    		nodedetail_props.isOpen = /*isDetailOpen*/ ctx[2];
    	}

    	nodedetail = new NodeDetail({ props: nodedetail_props, $$inline: true });
    	binding_callbacks.push(() => bind(nodedetail, 'node', nodedetail_node_binding));
    	binding_callbacks.push(() => bind(nodedetail, 'isOpen', nodedetail_isOpen_binding));
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			create_component(nodedetail.$$.fragment);
    			attr_dev(div0, "class", "zoom-control-container svelte-1ljxs7d");
    			add_location(div0, file$1, 227, 2, 7016);
    			attr_dev(div1, "id", "tree-container");
    			attr_dev(div1, "class", "svelte-1ljxs7d");
    			add_location(div1, file$1, 226, 0, 6987);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(zoomcontrol, div0, null);
    			append_dev(div1, t);
    			mount_component(nodedetail, div1, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const zoomcontrol_changes = {};
    			if (dirty & /*zoomLevel*/ 1) zoomcontrol_changes.zoomLevel = /*zoomLevel*/ ctx[0];
    			zoomcontrol.$set(zoomcontrol_changes);
    			const nodedetail_changes = {};

    			if (!updating_node && dirty & /*selectedNode*/ 2) {
    				updating_node = true;
    				nodedetail_changes.node = /*selectedNode*/ ctx[1];
    				add_flush_callback(() => updating_node = false);
    			}

    			if (!updating_isOpen && dirty & /*isDetailOpen*/ 4) {
    				updating_isOpen = true;
    				nodedetail_changes.isOpen = /*isDetailOpen*/ ctx[2];
    				add_flush_callback(() => updating_isOpen = false);
    			}

    			nodedetail.$set(nodedetail_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(zoomcontrol.$$.fragment, local);
    			transition_in(nodedetail.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(zoomcontrol.$$.fragment, local);
    			transition_out(nodedetail.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			destroy_component(zoomcontrol);
    			destroy_component(nodedetail);
    		}
    	};
    ...
    function transformData(data) {
    	const result = { name: Object.keys(data)[0], children: [] };
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('TreeGraph', slots, []);
    	let { treeData } = $$props;
    	let data = transformData(treeData);
    	let root, tree$1, diagonal, svg, gLink, gNode;
    	let zoom$1;
    	let g;
    	let zoomLevel = 100;
    	...
    	function handleNodeClick(event, d) {
    		$$invalidate(1, selectedNode = d);
    		$$invalidate(2, isDetailOpen = true);
    	...
    	function handleZoom(event) {
    		if (event.detail.direction === 'in') {
    			zoom$1.scaleBy(svg.transition().duration(750), 1.2);
    		} else if (event.detail.direction === 'out') {
    			zoom$1.scaleBy(svg.transition().duration(750), 1 / 1.2);
    		} else if (event.detail.level) {
    			const scale = event.detail.level / 100;
    			zoom$1.scaleTo(svg.transition().duration(750), scale);
    		}
    	}

    	function updateZoomLevel() {
    		$$invalidate(0, zoomLevel = Math.round(transform(svg.node()).k * 100));
    	}
    	...
    	function update(event, source) {
    		...
    		const transition = svg.transition().duration(duration).attr("height", newHeight).attr("viewBox", [-marginLeft, left.x - marginTop, width, newHeight]).tween("resize", window.ResizeObserver
    		? null
    		: () => () => svg.dispatch("toggle"));
    		...
    		const nodeEnter = node.enter().append("g").attr("transform", d => `translate(${source.y0},${source.x0})`).attr("fill-opacity", 0).attr("stroke-opacity", 0).on("click", handleNodeClick);

    		nodeEnter.append("circle").attr("r", 6).attr("fill", d => d._children ? "#555" : "#999").attr("stroke-width", 10); // Slightly larger circles

    		nodeEnter.append("text").attr("dy", "0.31em").attr("x", d => d._children ? -12 : 12).attr("text-anchor", d => d._children ? "end" : "start").text(d => d.data.name).attr("stroke-linejoin", "round").attr("stroke-width", 3).attr("stroke", "white").attr("paint-order", "stroke").style("font-size", "14px"); // Move text slightly further from node
    		// Increase font size
    	...
    	onMount(() => {
    		root = hierarchy(data);
    		tree$1 = tree().size([height - marginTop - marginBottom, width - marginRight - marginLeft]);
    		diagonal = linkHorizontal().x(d => d.y).y(d => d.x);
    		svg = select("#tree-container").append("svg").attr("width", width).attr("height", height).attr("viewBox", [0, 0, width, height]).attr("style", "max-width: 100%; height: auto; font: 14px sans-serif; user-select: none;");

    		// Add zoom behavior
    		zoom$1 = zoom().scaleExtent([0.1, 4]).on("zoom", event => {
    			zoomed(event);
    			updateZoomLevel();
    		});
    		...
    		g = svg.append("g").attr("transform", `translate(${marginLeft},${marginTop})`);

    		gLink = g.append("g").attr("fill", "none").attr("stroke", "#555").attr("stroke-opacity", 0.4).attr("stroke-width", 1.5);
    		gNode = g.append("g").attr("cursor", "pointer").attr("pointer-events", "all");
    		root.x0 = height / 2;
    		root.y0 = 0;
    		...
    		// Center the graph
    		const initialTransform = identity.translate(width / 2, height / 2).scale(0.8);

    		svg.call(zoom$1.transform, initialTransform);
    	});

    	$$self.$$.on_mount.push(function () {
    		if (treeData === undefined && !('treeData' in $$props || $$self.$$.bound[$$self.$$.props['treeData']])) {
    			console.warn("<TreeGraph> was created without expected prop 'treeData'");
    		}
    	});
    	...
    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<TreeGraph> was created with unknown prop '${key}'`);
    	});

    	function nodedetail_node_binding(value) {
    		selectedNode = value;
    		$$invalidate(1, selectedNode);
    	}

    	function nodedetail_isOpen_binding(value) {
    		isDetailOpen = value;
    		$$invalidate(2, isDetailOpen);
    	}

    	$$self.$$set = $$props => {
    		if ('treeData' in $$props) $$invalidate(4, treeData = $$props.treeData);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('tree' in $$props) tree$1 = $$props.tree;
    		...
    		if ('zoom' in $$props) zoom$1 = $$props.zoom;
    		if ('g' in $$props) g = $$props.g;
    		if ('zoomLevel' in $$props) $$invalidate(0, zoomLevel = $$props.zoomLevel);
    		if ('selectedNode' in $$props) $$invalidate(1, selectedNode = $$props.selectedNode);
    		if ('isDetailOpen' in $$props) $$invalidate(2, isDetailOpen = $$props.isDetailOpen);
    	};
    	...
    	return [
    		...
    		handleZoom,
    		treeData,
    		nodedetail_node_binding,
    		nodedetail_isOpen_binding
    	];
    }

    class TreeGraph extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal, { treeData: 4 });
    	...
    	get treeData() {
    		throw new Error("<TreeGraph>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set treeData(value) {
    		throw new Error("<TreeGraph>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Advisor Box Tree";
    			t1 = space();
    			create_component(treegraph.$$.fragment);
    			attr_dev(h1, "class", "svelte-116bbmy");
    			add_location(h1, file, 6, 1, 101);
    			attr_dev(main, "class", "svelte-116bbmy");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t1);
    			mount_component(treegraph, main, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const treegraph_changes = {};
    			if (dirty & /*treeData*/ 1) treegraph_changes.treeData = /*treeData*/ ctx[0];
    			treegraph.$set(treegraph_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(treegraph.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(treegraph.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(treegraph);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (treeData === undefined && !('treeData' in $$props || $$self.$$.bound[$$self.$$.props['treeData']])) {
    			console.warn("<App> was created without expected prop 'treeData'");
    		}
    	});
    	...
    	$$self.$$set = $$props => {
    		if ('treeData' in $$props) $$invalidate(0, treeData = $$props.treeData);
    	};

    	$$self.$capture_state = () => ({ TreeGraph, treeData });
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance, create_fragment, safe_not_equal, { treeData: 0 });
